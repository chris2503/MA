			...
			for j in range(subdets):	# for all 4 sectors
				...
				if Q_val_returns:
					...
					if temp_contrib_at116Cd < 1.0:
						...
						temp_contrib_at116Cd_err = scale * 1/np.sqrt(contrib_at116Cd)

					if temp_contrib_at130Te < 1.0:
						temp_contrib_at130Te_err = 0.0
					else:
						temp_contrib_at130Te_err = scale * 1/np.sqrt(contrib_at130Te)
				...
				if Q_val_returns:
					t_d_contrib_at116Cd.append(temp_contrib_at116Cd)
					t_d_contrib_at130Te.append(temp_contrib_at130Te)
					t_d_contrib_at116Cd_err.append(temp_contrib_at116Cd_err)
					t_d_contrib_at130Te_err.append(temp_contrib_at130Te_err)
			if Q_val_returns:
