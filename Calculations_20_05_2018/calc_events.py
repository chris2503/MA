...
# calculate the real number of events of the selected istotope for a period of time (e.g 1year for norming ;) )
...
print('Total fraction of the isotopes in the chemical compund: \n %s' %(tot_iso_perc))
print('')
...
# TOTAL NUMBER OF EVENTS NORMED TO detector mass [kg] for 1 year
N_iso_normed = N_iso_ev * 1/(mass_det_comp[0])					#	9 detectors
print('Total number of events after 1 year normed to detector mass: \n %s' %(N_iso_normed))
print('')	


### export data to a txt-file
# for saving data to a table, data must be transposed
new_data = np.array([iso_list, tot_iso_perc, tot_iso_mass, spec_ac, N_iso_normed])
...
descriptions = ['List of calculated variables',
				...
				'N_normed: REAL NUMBER of events normed per 1kg detector mass AND 1year']
var_names = ['isotope', 'p', 'm / [kg]', 'a / [Bq/kg]', 'N_normed [1/(kg*yr)]']
